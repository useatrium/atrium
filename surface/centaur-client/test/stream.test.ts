    ...
    const frames: CentaurEventFrame[] = [
      {
        event: 'execution_state',
        event_id: 1,
        data: { type: 'execution.state', status: 'queued', thread_key: 't', execution_id: 'e' },
      },
      {
        event: 'execution_state',
        event_id: 2,
      ...
      { event: 'amp_raw_event', event_id: 3, data: { type: 'result', text: 'ok' } },
      {
        event: 'execution_state',
        event_id: 4,
        data: { type: 'execution.state', status: 'completed', thread_key: 't', execution_id: 'e', result_text: 'ok' },
      },
    ];
    ...
    expect(yielded).toEqual([
      {
        event: 'execution_state',
        event_id: 1,
        data: { type: 'execution.state', status: 'running', thread_key: 'probe:1', execution_id: 'exe_1' },
      },
