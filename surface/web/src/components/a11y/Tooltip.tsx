      ...
      <RadixTooltip.Root disableHoverableContent>
        ...
        <RadixTooltip.Portal>
          <RadixTooltip.Content
            ...
            className="pointer-events-none z-tooltip flex max-w-[min(20rem,80vw)] select-none items-center gap-1.5 rounded-md border border-edge-strong bg-surface-overlay px-2 py-1 text-xs font-medium text-fg-secondary shadow-lg"
          >
            <span>{content}</span>
