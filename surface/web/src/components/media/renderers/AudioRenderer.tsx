...
export function AudioRenderer({ file, variant }: { file: PreviewFile; variant: MediaPreviewVariant }) {
  if (variant === 'tile') {
    return (
      <div className="flex h-full min-h-0 flex-col items-center justify-center gap-2 bg-surface-raised/50 p-3">
  ...
  return (
    <div className="flex h-full min-h-72 items-center justify-center p-6" data-lightbox-backdrop>
      <div className="w-[min(560px,100%)] rounded-lg border border-edge bg-surface p-5 shadow-2xl">
