...
export function CodeRenderer({ file, variant }: { file: PreviewFile; variant: MediaPreviewVariant }) {
  ...
  return (
    <div className="h-full overflow-y-auto px-4 py-6 md:px-8" data-lightbox-backdrop>
      <div className="mx-auto max-w-6xl overflow-hidden rounded-xl border border-edge bg-surface shadow-2xl">
        <div className="flex items-center gap-2 border-b border-edge bg-surface-raised/45 px-4 py-2">
